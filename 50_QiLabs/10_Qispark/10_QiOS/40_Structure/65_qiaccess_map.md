---
layout: page
title: QiAccess Config Map
slug: qiaccess-config-map
status: publish
...
realm_label: ""
uid: d8b7c1f7ed7649768f68ede367d5037b
canonical_ref: ""
  ...
  root((QiAccess))
    ...
    Bookmarks
      External / Mobile Functions
        ...
        Gmail [GM]
        Google Calendar [GC]
        Google Drive / QiNexus [QD]
        NotebookLM [NL]
      Finance + Admin Links
        Care/admin links [CA]
        Cloudflare Dashboard [CF]
        Family Wall [FW]
        Finance portals [FP]
      Reference + Notes
        Documentation / QiCore [QC]
        Recovery notes [RN]
    Services
      Automation
        n8n
