...
- [x] Enable the Obsidian **Bases** core plugin. ✅ 2026-06-27
- [x] Confirm TaskNotes has created the default `.base` files in `TaskNotes/Views/`. ✅ 2026-06-27
- [x] Open the command palette and run **TaskNotes: Open tasks view**. ✅ 2026-06-27
